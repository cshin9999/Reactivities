                    ...
                    <FinalForm validate={validate} initialValues = {activity} onSubmit={handleFinalFormSubmit} render={ ({ handleSubmit, invalid, pristine }) => (
                        ...
                        <Form onSubmit={handleSubmit} loading={loading}>
                            ...
                            <Form.Group widths='equal'>
                                <Field name='date' placeholder='Date' value={activity.date} date={true} component={DateInput} />
                                <Field name='time' placeholder='Time' value={activity.time} time={true} component={DateInput} />
                            </Form.Group>
